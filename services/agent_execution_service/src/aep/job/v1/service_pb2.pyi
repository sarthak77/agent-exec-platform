...
class Job(_message.Message):
    __slots__ = ("id", "type", "spec", "status", "attempts", "max_attempts", "metadata", "retry_count", "max_retries", "result")
    ID_FIELD_NUMBER: _ClassVar[int]
    TYPE_FIELD_NUMBER: _ClassVar[int]
    SPEC_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
    ...
    max_retries: int
    result: JobResult
    def __init__(self, id: _Optional[str] = ..., type: _Optional[_Union[JobType, str]] = ..., spec: _Optional[_Union[JobSpec, _Mapping]] = ..., status: _Optional[_Union[JobStatus, str]] = ..., attempts: _Optional[int] = ..., max_attempts: _Optional[int] = ..., metadata: _Optional[_Union[JobMetadata, _Mapping]] = ..., retry_count: _Optional[int] = ..., max_retries: _Optional[int] = ..., result: _Optional[_Union[JobResult, _Mapping]] = ...) -> None: ...
