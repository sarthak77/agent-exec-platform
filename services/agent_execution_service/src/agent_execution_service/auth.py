...
It only extracts the tenant id every query is scoped by, standing in for an
upstream edge that decodes a verified JWT and forwards the claim as a plain
...
from agent_execution_service.errors import AuthenticationError
